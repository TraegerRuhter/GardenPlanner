...
// one tapered leaf radiating from (bx,by) at angle ang: dark edges separate it, light midrib
function leafBlade(g, bx, by, ang, len, w0) {
...
// little curling tendril ("spindly bit")
function tendril(g, x, y, dir) {
